...
Source: `sdk/deploykit/order.go` (`BuilderRefForFormat`, relocated from `charly/generate.go` in #67), `charly/graph.go` (`ResolveBoxOrder`, `BoxNeedsBuilder`), `candy/plugin-box/validate_graph.go` (`validateBuilders`).
